						...
						<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 224px;text-align: center;">Usernme</th>
							...
							<tbody>
								...
								<tr role="row" class="odd">
									...
									<td>{{ $user->username }}</td>
									<td><img src="images/users/{{ $user->avatar }}" class="attachment-img" alt="User Image"></td>
									<td>{{ $user->email }}</td>
									<td>{{ $user->gender }}</td>
									<td>@if($user->status == 0)
