...
<link rel="stylesheet" href="{{ asset('frontend/css/nivo-slider.css') }}" type="text/css" />
...
<script src="{{ asset('frontend/js/jquery.rateit.js')}}" type="text/javascript"></script>
<script src="{{ asset('frontend/js/jquery.rateit.min.js')}}" type="text/javascript"></script>
...
{{-- <script src="{{ asset('bower_components/jquery.rateit/scripts/rateit.css') }}"></script> --}}
